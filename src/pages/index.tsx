      ...
      <div className={`container mx-auto flex flex-col items-center justify-center mt-16 `}>
        ...
        <div className='grid md:grid-cols-2 mt-4 gap-2'>
          ...
          <div className='max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
            ...
            <Link href={'https://ismaelb.notion.site/0297480c38c6455f86878d896c1b323e?v=6cd093c80ce1449a9e32a27f96926302'} className='w-full justify-center gap-2 text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2'>
